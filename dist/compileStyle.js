...
function compileStyle(options) {
  return doCompileStyle(
    Object.assign(Object.assign({}, options), { isAsync: false })
  )
}
exports.compileStyle = compileStyle
function compileStyleAsync(options) {
  return Promise.resolve(
    doCompileStyle(Object.assign(Object.assign({}, options), { isAsync: true }))
  )
}
...
function doCompileStyle(options) {
  ...
  const preprocessor =
    preprocessLang && styleProcessors_1.processors[preprocessLang]
  ...
  const postCSSOptions = Object.assign(Object.assign({}, postcssOptions), {
    to: filename,
    from: filename
  })
  if (map) {
